...
// if i try to do it with specialized classes in this way instead of a generic tree structure;
// then this is going to be too tough because of lot of circular dependencies
// refractor to generic tree structure.   
